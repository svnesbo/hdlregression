...
def add_uvvm_basic(hr):
    hr.add_files(filename='../../uvvm_internal/uvvm_util/src/*.vhd',
                      library_name='uvvm_util')
    hr.add_files(filename='../../uvvm_internal/uvvm_vvc_framework/src/*.vhd',
                      library_name='uvvm_vvc_framework')
    hr.add_files(filename='../../uvvm_internal/bitvis_vip_scoreboard/src/*.vhd',
...
def test_1(hr):
    ...
    # ========================================================================
    # Add DUT
    hr.add_files(filename='../../uvvm_internal/bitvis_uart/src/*.vhd',
                library_name='bitvis_uart',
                code_coverage=True)

    hr.add_files(filename='../../uvvm_internal/bitvis_irqc/src/*.vhd',
                 library_name='bitvis_irqc')

    # ========================================================================
    # Add verification IPs
    hr.add_files(filename='../../uvvm_internal/bitvis_vip_sbi/src/*.vhd',
                 library_name='bitvis_vip_sbi')
    hr.add_files(filename='../../uvvm_internal/uvvm_vvc_framework/src_target_dependent/*.vhd',
                 library_name='bitvis_vip_sbi')

    hr.add_files(filename='../../uvvm_internal/bitvis_vip_uart/src/*.vhd',
                 library_name='bitvis_vip_uart')
    hr.add_files(filename='../../uvvm_internal/uvvm_vvc_framework/src_target_dependent/*.vhd',
                 library_name='bitvis_vip_uart')

    hr.add_files(filename='../../uvvm_internal/bitvis_vip_clock_generator/src/*.vhd',
    ...
    # ========================================================================
    # Add testbench
    hr.add_files(filename='../../uvvm_internal/bitvis_uart/tb/*.vhd',
                 library_name='bitvis_uart')
    hr.add_files(filename='../../uvvm_internal/bitvis_uart/tb/maintenance_tb/*.vhd',
                 library_name='bitvis_uart')

    hr.add_files(filename='../../uvvm_internal/bitvis_irqc/tb/*.vhd',
                 library_name='bitvis_irqc')
    hr.add_files(filename='../../uvvm_internal/bitvis_irqc/tb/maintenance_tb/*.vhd',
                 library_name='bitvis_irqc')

    # ========================================================================
    # Create test groups
    hr.add_to_testgroup(testgroup_name='uart_vvc_tb_all',
                        entity='uart_vvc_tb',
                        architecture='func')
    hr.add_to_testgroup(testgroup_name='transmit_tests',
                        entity='uart_vvc_tb',
                        architecture='func',
                        testcase='*transmit*')
    hr.add_to_testgroup(testgroup_name='receive_tests',
                        entity='uart_vvc_tb',
                        architecture='func',
                        testcase='*receive*')

    hr.add_to_testgroup(testgroup_name='selection_tests',
                        entity='uart_vvc_demo_tb')
    hr.add_to_testgroup(testgroup_name='selection_tests',
                        entity='uart_simple_bfm_tb')
...
def test_2(hr):
    hr.add_files(filename='../../uvvm_internal/uvvm_util/src/*.vhd',
                library_name='uvvm_util')
    hr.add_files(filename='tb/demo_tb.vhd',
                 library_name='test_2_lib')
